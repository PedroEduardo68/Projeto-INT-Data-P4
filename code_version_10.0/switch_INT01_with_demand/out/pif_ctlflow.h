...
#define PIF_CTLFLOW_STATE_ingress_flow__condition_1 0
#define PIF_CTLFLOW_STATE_ingress_flow__condition_2 1
#define PIF_CTLFLOW_STATE_ingress_flow_ingress__arp_lpm 2
#define PIF_CTLFLOW_STATE_ingress_flow_ingress__tbl_act_1 3
#define PIF_CTLFLOW_STATE_ingress_flow__condition_0 4
#define PIF_CTLFLOW_STATE_ingress_flow_ingress__tbl_act_0 5
#define PIF_CTLFLOW_STATE_ingress_flow__condition_4 6
#define PIF_CTLFLOW_STATE_ingress_flow_ingress__int_source 7
#define PIF_CTLFLOW_STATE_ingress_flow__condition_3 8
#define PIF_CTLFLOW_STATE_ingress_flow_ingress__ipv4_lpm 9
...
#define PIF_CTLFLOW_STATE__condition_1 0
#define PIF_CTLFLOW_STATE__condition_2 1
#define PIF_CTLFLOW_STATE_ingress__arp_lpm 2
#define PIF_CTLFLOW_STATE_ingress__tbl_act_1 3
#define PIF_CTLFLOW_STATE__condition_0 4
#define PIF_CTLFLOW_STATE_ingress__tbl_act_0 5
#define PIF_CTLFLOW_STATE__condition_4 6
#define PIF_CTLFLOW_STATE_ingress__int_source 7
#define PIF_CTLFLOW_STATE__condition_3 8
#define PIF_CTLFLOW_STATE_ingress__ipv4_lpm 9
