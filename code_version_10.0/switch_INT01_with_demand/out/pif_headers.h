...
/* countpackage (4B) */
struct pif_header_countpackage {
...
struct pif_header_report {
    ...
    /* f_rsvd [13;3] */
    unsigned int f_rsvd:13;
    /* f_rsvd [3;0] */
    unsigned int __f_rsvd_1:3;
    unsigned int f_hw_id:8;
    /* f_seq_num [21;11] */
    unsigned int f_seq_num:21;
    /* f_seq_num [11;0] */
    unsigned int __f_seq_num_1:11;
    /* f_ingress_ts [21;43] */
    unsigned int f_ingress_ts:21;
    /* f_ingress_ts [32;11] */
    unsigned int __f_ingress_ts_1:32;
    /* f_ingress_ts [11;0] */
    unsigned int __f_ingress_ts_2:11;
...
#define PIF_HEADER_GET_report___f_rsvd(_hdr_p) (((_hdr_p)->f_rsvd << 3) | ((_hdr_p)->__f_rsvd_1)) /* report.f_rsvd [16;0] */

#define PIF_HEADER_SET_report___f_rsvd(_hdr_p, _val) \
    do { \
        (_hdr_p)->f_rsvd = (unsigned)(((_val) >> 3)); \
        (_hdr_p)->__f_rsvd_1 = (unsigned)(((_val))); \
    } while (0) /* report.f_rsvd[16;0] */
...
#define PIF_HEADER_GET_report___f_seq_num(_hdr_p) (((_hdr_p)->f_seq_num << 11) | ((_hdr_p)->__f_seq_num_1)) /* report.f_seq_num [32;0] */

#define PIF_HEADER_SET_report___f_seq_num(_hdr_p, _val) \
    do { \
        (_hdr_p)->f_seq_num = (unsigned)(((_val) >> 11)); \
        (_hdr_p)->__f_seq_num_1 = (unsigned)(((_val))); \
    } while (0) /* report.f_seq_num[32;0] */

#define PIF_HEADER_GET_report___f_ingress_ts___0(_hdr_p) ((((_hdr_p)->__f_ingress_ts_1 & 0x1fffff) << 11) | ((_hdr_p)->__f_ingress_ts_2)) /* report.f_ingress_ts [32;0] */

#define PIF_HEADER_SET_report___f_ingress_ts___0(_hdr_p, _val) \
    do { \
        (_hdr_p)->__f_ingress_ts_1 &= (unsigned)(0xffe00000); \
        (_hdr_p)->__f_ingress_ts_1 |= (unsigned)((((_val) >> 11) & 0x1fffff)); \
        (_hdr_p)->__f_ingress_ts_2 = (unsigned)(((_val))); \
    } while (0) /* report.f_ingress_ts[32;0] */

#define PIF_HEADER_GET_report___f_ingress_ts___1(_hdr_p) (((_hdr_p)->f_ingress_ts << 11) | (((_hdr_p)->__f_ingress_ts_1 >> 21) & 0x7ff)) /* report.f_ingress_ts [32;32] */

#define PIF_HEADER_SET_report___f_ingress_ts___1(_hdr_p, _val) \
    do { \
        (_hdr_p)->f_ingress_ts = (unsigned)(((_val) >> 11)); \
        (_hdr_p)->__f_ingress_ts_1 &= (unsigned)(0x1fffff); \
        (_hdr_p)->__f_ingress_ts_1 |= (unsigned)((((_val) & 0x7ff) << 21)); \
    } while (0) /* report.f_ingress_ts[32;32] */

#define PIF_HEADER_GET_report____padding(_hdr_p) (((_hdr_p)->_padding)) /* report._padding [5;0] */

#define PIF_HEADER_SET_report____padding(_hdr_p, _val) \
    do { \
        (_hdr_p)->_padding = (unsigned)(((_val))); \
    } while (0) /* report._padding[5;0] */
...
struct pif_header_switch_local {
    ...
    /* ingressbyte [24;8] */
    unsigned int ingressbyte:24;
    /* ingressbyte [8;0] */
    unsigned int __ingressbyte_1:8;
    /* ingresspackage [24;8] */
    unsigned int ingresspackage:24;
    /* ingresspackage [8;0] */
    unsigned int __ingresspackage_1:8;
};
...
#define PIF_HEADER_GET_switch_local___ingressbyte(_hdr_p) (((_hdr_p)->ingressbyte << 8) | ((_hdr_p)->__ingressbyte_1)) /* switch_local.ingressbyte [32;0] */

#define PIF_HEADER_SET_switch_local___ingressbyte(_hdr_p, _val) \
    do { \
        (_hdr_p)->ingressbyte = (unsigned)(((_val) >> 8)); \
        (_hdr_p)->__ingressbyte_1 = (unsigned)(((_val))); \
    } while (0) /* switch_local.ingressbyte[32;0] */

#define PIF_HEADER_GET_switch_local___ingresspackage(_hdr_p) (((_hdr_p)->ingresspackage << 8) | ((_hdr_p)->__ingresspackage_1)) /* switch_local.ingresspackage [32;0] */

#define PIF_HEADER_SET_switch_local___ingresspackage(_hdr_p, _val) \
    do { \
        (_hdr_p)->ingresspackage = (unsigned)(((_val) >> 8)); \
        (_hdr_p)->__ingresspackage_1 = (unsigned)(((_val))); \
    } while (0) /* switch_local.ingresspackage[32;0] */


/* ingress::scalars (24B) */
struct pif_header_ingress__scalars {
    unsigned int tmp_0:32;
    unsigned int tmp_1:32;
    unsigned int tmp_2:32;
    unsigned int tmp_3:32;
    unsigned int tmp_4:32;
    unsigned int tmp:32;
};

/* ingress::scalars field accessor macros */
#define PIF_HEADER_GET_ingress__scalars___tmp_0(_hdr_p) (((_hdr_p)->tmp_0)) /* ingress::scalars.tmp_0 [32;0] */

#define PIF_HEADER_SET_ingress__scalars___tmp_0(_hdr_p, _val) \
    do { \
        (_hdr_p)->tmp_0 = (unsigned)(((_val))); \
    } while (0) /* ingress::scalars.tmp_0[32;0] */

#define PIF_HEADER_GET_ingress__scalars___tmp_1(_hdr_p) (((_hdr_p)->tmp_1)) /* ingress::scalars.tmp_1 [32;0] */

#define PIF_HEADER_SET_ingress__scalars___tmp_1(_hdr_p, _val) \
    do { \
        (_hdr_p)->tmp_1 = (unsigned)(((_val))); \
    } while (0) /* ingress::scalars.tmp_1[32;0] */

#define PIF_HEADER_GET_ingress__scalars___tmp_2(_hdr_p) (((_hdr_p)->tmp_2)) /* ingress::scalars.tmp_2 [32;0] */

#define PIF_HEADER_SET_ingress__scalars___tmp_2(_hdr_p, _val) \
    do { \
        (_hdr_p)->tmp_2 = (unsigned)(((_val))); \
    } while (0) /* ingress::scalars.tmp_2[32;0] */

#define PIF_HEADER_GET_ingress__scalars___tmp_3(_hdr_p) (((_hdr_p)->tmp_3)) /* ingress::scalars.tmp_3 [32;0] */

#define PIF_HEADER_SET_ingress__scalars___tmp_3(_hdr_p, _val) \
    do { \
        (_hdr_p)->tmp_3 = (unsigned)(((_val))); \
    } while (0) /* ingress::scalars.tmp_3[32;0] */

#define PIF_HEADER_GET_ingress__scalars___tmp_4(_hdr_p) (((_hdr_p)->tmp_4)) /* ingress::scalars.tmp_4 [32;0] */

#define PIF_HEADER_SET_ingress__scalars___tmp_4(_hdr_p, _val) \
    do { \
        (_hdr_p)->tmp_4 = (unsigned)(((_val))); \
    } while (0) /* ingress::scalars.tmp_4[32;0] */

#define PIF_HEADER_GET_ingress__scalars___tmp(_hdr_p) (((_hdr_p)->tmp)) /* ingress::scalars.tmp [32;0] */

#define PIF_HEADER_SET_ingress__scalars___tmp(_hdr_p, _val) \
    do { \
        (_hdr_p)->tmp = (unsigned)(((_val))); \
    } while (0) /* ingress::scalars.tmp[32;0] */
...
/* bytecountingress (4B) */
struct pif_header_bytecountingress {
    unsigned int value:32;
};

/* bytecountingress field accessor macros */
#define PIF_HEADER_GET_bytecountingress___value(_hdr_p) (((_hdr_p)->value)) /* bytecountingress.value [32;0] */

#define PIF_HEADER_SET_bytecountingress___value(_hdr_p, _val) \
    do { \
        (_hdr_p)->value = (unsigned)(((_val))); \
    } while (0) /* bytecountingress.value[32;0] */


/* ingresscount (4B) */
struct pif_header_ingresscount {
    unsigned int value:32;
};

/* ingresscount field accessor macros */
#define PIF_HEADER_GET_ingresscount___value(_hdr_p) (((_hdr_p)->value)) /* ingresscount.value [32;0] */

#define PIF_HEADER_SET_ingresscount___value(_hdr_p, _val) \
    do { \
        (_hdr_p)->value = (unsigned)(((_val))); \
    } while (0) /* ingresscount.value[32;0] */
