...
static int handle_ingress_flow__condition_1(__lmem uint32_t *_pif_parrep)
{
    ...
    //expression _condition_1: ((ipv4.typeServiceDiffServ) == (23))
    {
    ...
    pif_expression__condition_1_register_1 = ipv4->typeServiceDiffServ;
    pif_expression__condition_1_register_2 = 0x17;
    /* implicit cast 5 -> 8 */
    pif_expression__condition_1_register_3 = pif_expression__condition_1_register_2 & 0x1f;
...
static int handle_ingress_flow__condition_2(__lmem uint32_t *_pif_parrep)
{
    ...
    //expression _condition_2: (valid(arp))
    {
    //subexpression 0: valid(arp)
    pif_expression__condition_2_register_0 = PIF_PARREP_arp_VALID(prdata);
    }
...
static int handle_ingress_flow__condition_0(__lmem uint32_t *_pif_parrep)
{
    ...
    //expression _condition_0: (valid(ethernet))
    {
    //subexpression 0: valid(ethernet)
    pif_expression__condition_0_register_0 = PIF_PARREP_ethernet_VALID(prdata);
    }
...
static int handle_ingress_flow__condition_4(__lmem uint32_t *_pif_parrep)
{
    ...
    if (pif_expression__condition_4_register_0)
        return PIF_CTLFLOW_STATE_ingress_flow_ingress__int_source;
    else
        return PIF_CTLFLOW_STATE_ingress_flow_exit_control_flow;
}

static int handle_ingress_flow_ingress__int_source(__lmem uint32_t *_pif_parrep, __mem __addr40 uint32_t *actbuf, unsigned int actbuf_off, int *actlen, int *state)
{
    __gpr int action_id, ret;
    int next_state = PIF_CTLFLOW_STATE_ingress_flow_DONE;

#ifdef PIF_DEBUG
    __debug_label("pif_ctlflow_state_ingress_flow_ingress__int_source");
#endif

    {
        struct pif_lookup_result result;
        result = pif_lookup(PIF_TABLE_ID_ingress__int_source, _pif_parrep, actbuf, actbuf_off);
        action_id = result.action_id;
        *actlen = result.action_len;
    }
...
static int handle_ingress_flow__condition_3(__lmem uint32_t *_pif_parrep)
{
    ...
    //expression _condition_3: (valid(ipv4))
    {
    //subexpression 0: valid(ipv4)
    pif_expression__condition_3_register_0 = PIF_PARREP_ipv4_VALID(prdata);
    }
...
int pif_ctlflow_ingress_flow(int *start_state, __lmem uint32_t *_pif_parrep, __mem __addr40 uint32_t *actbuf, unsigned int actbuf_off)
{
    ...
    while (pif_ctlflow_state_ingress_flow != PIF_CTLFLOW_STATE_ingress_flow_DONE) {
        ...
        case PIF_CTLFLOW_STATE_ingress_flow__condition_4:
            ...
            continue;
        case PIF_CTLFLOW_STATE_ingress_flow_ingress__int_source:
            ret = handle_ingress_flow_ingress__int_source(_pif_parrep, actbuf, actbuf_off + totlen, (int *)&actlen, (int *)&pif_ctlflow_state_ingress_flow);
            break;
...
static int handle_egress_flow__condition_5(__lmem uint32_t *_pif_parrep)
{
    ...
    //expression _condition_5: (valid(hopINT))
    {
    //subexpression 0: valid(hopINT)
    pif_expression__condition_5_register_0 = PIF_PARREP_hopINT_VALID(prdata);
    }
