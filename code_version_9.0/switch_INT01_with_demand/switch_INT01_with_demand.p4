...
const bit<16> INT_OUT_TIMESTAMP_SIZE = 8;
...
//bit 5 - not definy by noveflow

//bit 6 - not definy by noveflow
...
const bit<16> INT_TAIL_HEADER_LEN = 8;
...
// **********  header INT data    **********
    ...
    action action_tail(){
        hdr.tailINT.setValid();
        hdr.tailINT.tail_header = 255;
        hdr.tailINT.tail_proto = hdr.ipv4.protocol;    
        hdr.tailINT.tail_port =  hdr.udp.destinationPort;
        hdr.tailINT.tail_dscp =  hdr.ipv4.typeServiceDiffServ;
    } 
    ...
    table add_metadata {
        ...
        key = {
            hdr.hopINT.int_instruction_bit: exact;
        }
...
// action_eq248   = 11111000 //full telemetry
