...
#define PIF_CTLFLOW_STATE_ingress_flow_ingress__process_int_report 1
#define PIF_CTLFLOW_STATE_ingress_flow_ingress__ipv4_lpm 2
...
#define PIF_CTLFLOW_STATE_ingress__process_int_report 1
#define PIF_CTLFLOW_STATE_ingress__ipv4_lpm 2
