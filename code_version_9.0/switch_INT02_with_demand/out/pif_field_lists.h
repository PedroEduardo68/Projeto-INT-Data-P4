...
struct pif_field_list_field_list_2 {
    union {
        struct {
            /* report_ipv4.sourceAddress[32;0] */
            unsigned int __report_ipv4__sourceAddress:32;
            /* report_ipv4.destinationAddress[32;0] */
            unsigned int __report_ipv4__destinationAddress:32;
            /* report_ipv4.totalLength[16;0] */
            unsigned int __report_ipv4__totalLength:16;
            /* report_ipv4.identification[16;0] */
            unsigned int __report_ipv4__identification:16;
            /* report_ipv4.fragmentOffset[16;0] */
            unsigned int __report_ipv4__fragmentOffset:16;
            /* report_ipv4.typeServiceDiffServ[8;0] */
            unsigned int __report_ipv4__typeServiceDiffServ:8;
            /* report_ipv4.timeToLive[8;0] */
            unsigned int __report_ipv4__timeToLive:8;
            unsigned int _padding_0:16;
            /* report_ipv4.protocol[8;0] */
            unsigned int __report_ipv4__protocol:8;
            /* report_ipv4.version[4;0] */
            unsigned int __report_ipv4__version:4;
            /* report_ipv4.headerLength[4;0] */
            unsigned int __report_ipv4__headerLength:4;
        };
        uint32_t _raw[5];
    };
};
...
struct pif_field_list_field_list_2_packed {
    union {
        __packed struct {
            /* report_ipv4.version[4;0] */
            unsigned int __report_ipv4__version:4;
            /* report_ipv4.headerLength[4;4] */
            unsigned int __report_ipv4__headerLength:4;
            /* report_ipv4.typeServiceDiffServ[8;8] */
            unsigned int __report_ipv4__typeServiceDiffServ:8;
            /* report_ipv4.totalLength[16;16] */
            unsigned int __report_ipv4__totalLength:16;
            /* report_ipv4.identification[16;32] */
            unsigned int __report_ipv4__identification:16;
            /* report_ipv4.fragmentOffset[16;48] */
            unsigned int __report_ipv4__fragmentOffset:16;
            /* report_ipv4.timeToLive[8;64] */
            unsigned int __report_ipv4__timeToLive:8;
            /* report_ipv4.protocol[8;72] */
            unsigned int __report_ipv4__protocol:8;
            /* report_ipv4.sourceAddress[32;80] */
            unsigned int __report_ipv4__sourceAddress:32;
            /* report_ipv4.destinationAddress[32;112] */
            unsigned int __report_ipv4__destinationAddress:32;
