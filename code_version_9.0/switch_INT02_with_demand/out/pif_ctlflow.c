...
static int handle_egress_flow__condition_3(__lmem uint32_t *_pif_parrep)
{
    ...
    //expression _condition_3: ((report_ipv4.typeServiceDiffServ) == (23))
    {
    ...
    pif_expression__condition_3_register_1 = report_ipv4->typeServiceDiffServ;
    pif_expression__condition_3_register_2 = 0x17;
    /* implicit cast 5 -> 8 */
    pif_expression__condition_3_register_3 = pif_expression__condition_3_register_2 & 0x1f;
